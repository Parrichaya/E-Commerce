document.addEventListener('DOMContentLoaded', function() {
  ...
  function AdminProducts() {
    axios
      .get('http://13.236.146.218:4000/admin/products', { headers: { "Authorization": localStorage.getItem("token") } })
      .then(response => {
  ...
  function Products() {
    ...
    axios
      .get('http://13.236.146.218:4000/shop/products', { headers: { "Authorization": localStorage.getItem("token") } })
      .then(response => {
        const products = response.data.products;
  ...
  function Cart() {
    ...
    axios
      .get('http://13.236.146.218:4000/shop/cart', { headers: { "Authorization": localStorage.getItem("token") } })
      .then(response => {
        const products = response.data.products;
  ...
  function Orders() {
    ...
    axios
      .get('http://13.236.146.218:4000/shop/orders', { headers: { "Authorization": localStorage.getItem("token") } })
      .then(response => {
  ...
  function handleAddProduct(event) {
    ...
    axios.post("http://13.236.146.218:4000/admin/add-product", { title, price, description }, { headers: { "Authorization": localStorage.getItem("token") } })
      .then(response => {
  ...
  if (currentPath.includes('admin-products.html')) {
    ...
    document.getElementById('admin-product-list').addEventListener('click', function(event) {
      if (event.target.classList.contains('delete-product')) {
        ...
        axios.post('http://13.236.146.218:4000/admin/delete-product', 
          { productId: prodId },
    ...
    document.getElementById('admin-product-list').addEventListener('click', function(event) {
      if (event.target.classList.contains('edit')) {
        const prodId = event.target.getAttribute('data-id');
        axios.get(`http://13.236.146.218:4000/admin/edit-product/${prodId}`, { headers: { "Authorization": localStorage.getItem("token") } })
          .then(response => {
    ...
    document.getElementById('edit-product-form').addEventListener('submit', function(event) {
      ...
      axios.post(`http://13.236.146.218:4000/admin/edit-product`, 
    ...
    document.getElementById('product-list').addEventListener('click', function(event) {
      if (event.target.classList.contains('add-to-cart')) {
        const prodId = event.target.getAttribute('data-id');
        axios.post('http://13.236.146.218:4000/shop/cart', { productId: prodId }, { headers: { "Authorization": localStorage.getItem("token") } })
          .then(response => {
    ...
    document.getElementById('cart-list').addEventListener('click', function(event) {
      if (event.target.classList.contains('remove-from-cart')) {
        const prodId = event.target.getAttribute('data-id');
        axios.post('http://13.236.146.218:4000/shop/cart-delete-item', { productId: prodId } ,{ headers: { "Authorization": localStorage.getItem("token") } })
          .then(response => {
    ...
    document.getElementById('place-order').addEventListener('click', function() {
      axios.post('http://13.236.146.218:4000/shop/create-order', {}, { headers: { "Authorization": localStorage.getItem("token") } })
        .then(response => {
